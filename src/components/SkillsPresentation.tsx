  ...
  <>
    ...
    <div className="skills_presentation">
      ...
      <p>
        ...
        las mejores prácticas. Mi área principal es el Front-End con React, TypeScript,
        Redux, Material UI, creando aplicaciones web.
      </p>
      <p>
        Además conozco algunas tecnologías usadas en el Back-End como Express,
        Flask, MongoDB, SQLite, MariaDB, con las que he desarrolado APIs Rest-Full 
        o aplicaciones FullStack.
      </p>
      <p>
        <span>Puedes visitar mi perfil de </span>
        <a href="https://www.linkedin.com/in/aitorscinfo/">Linkedln</a>
        <span> para conocer más detalles sobre mi Experiencia o contactarme. </span>
      </p>
    </div>
  </>
);
